...
const SudokuCell = ({ value, isFixed, isSelected, isHighlighted, isError, onClick, onDoubleClick }: SudokuCellProps) => {
  return (
    <button
      ...
      disabled={isFixed}
      className={cn(
        "aspect-square w-full min-h-[44px] sm:min-h-[48px] md:min-h-[52px] flex items-center justify-center text-xl sm:text-2xl md:text-3xl font-semibold transition-all touch-manipulation",
